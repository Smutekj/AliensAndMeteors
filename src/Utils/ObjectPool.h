...
namespace utils
{
    ...
    struct ObjectPool
    {
        ...
        constexpr bool contains(int entity_ind) const
        {
            return entity2ind.at(entity_ind) != -1;
        }
    ...
    public:
        ...
        {
            assert(entity_ind < MAX_OBJECTS && contains(entity_ind));
            return objects.at(entity2ind.at(entity_ind));
        }
